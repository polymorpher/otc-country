...
import { FormHelperText, HStack } from '@chakra-ui/react'
...
import { prod, DEBUG_TEST_TOKEN } from '~/helpers/config'
...
const AssetSelect: React.FC<AssetSelectProps> = ({ value, onChange }) => {
  const asset = assets.find(asset => asset.value === value)
  const val = asset ?? assets[0]
